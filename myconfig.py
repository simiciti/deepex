...
bodyparts = ["com", "port", "nose", "r_ear", "l_ear", "tail", "ur_paw", "ul_paw", "lr_paw", "ll_paw"]  # Exact sequence of labels as were put by
# If center of mass was a labeled region in bodyparts 
center_of_mass = "com"
...
invisibleboundary=70 # If labels are closer to origin than this number they are set to NaN (not a number). Please adjust to your situation. Units in pixel.
 
imagetype=".tif" # image type of extracted frames (do not change if you used our step1). 
